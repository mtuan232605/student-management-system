...
router.post('/add', [ensureAuthenticated, isAdmin, createAccessControl], async (req, res) => {
    ...
    if (error) {
        ...
        const student = new Student({
            ...
            _CMND: req.body._CMND,
            CourseName: req.body.CourseName,
            BranchName: req.body.BranchName,
            Semester : req.body.SemesterAdmittedTo,
        ...
        const result = await Student.findOne({
            'StudentId._StudentId': req.body._StudentId
        });
...
router.get('/faker', async (req, res) => {
    for (let i = 0; i < 10; i++) {
        const student = new Student({
            ...
            Note: randomString.generate({
                length: 8,
                charset: 'numeric'
            }),
            StudentId: new StudentId({
                _StudentId: randomString.generate({
                    length: 8,
                    charset: 'numeric'
                })
            }),
